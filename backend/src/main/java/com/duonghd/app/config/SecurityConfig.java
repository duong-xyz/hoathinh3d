...
import com.duonghd.app.security.exception.CustomAccessDeniedHandler;
import com.duonghd.app.security.exception.CustomAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                ) //By default, Spring automatically adds the prefix "SCOPE_" to the values within the "scope" claim.
    ...
    public JwtAuthenticationConverter jwtAuthenticationConverter() {
        ...
        grantedAuthoritiesConverter.setAuthoritiesClaimName("scope"); // Read the string containing the list of roles "ROLE_ADMIN")
